...
using DoctorDBLibrary.PDF_Creator;
...
namespace DoctorDBLibrary
{
    ...
    public static class GlobalConfig
    {
        ...
        public static string ConnectionString = ConfigurationManager.ConnectionStrings["DoctorDB"].ConnectionString;
        ...
        public static CheckEvents CheckEvents { get; set; } = new CheckEvents();
        public static createPDF CreatePDF { get; set; } = new createPDF();
